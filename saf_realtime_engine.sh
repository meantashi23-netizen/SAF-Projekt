...
ffmpeg -y -i "$AUDIO_INPUT" \
  -filter_complex "[0:a]avectorscope=s=1920x1080:m=lissajous:rc=0:gc=255:bc=200:zoom=1.5[v];[v]drawtext=text='J(o) = 1.39 | Delta-Vortex Sync':x=100:y=100:fontsize=28:fontcolor=white:box=1:boxcolor=black@0.5[out]" \
